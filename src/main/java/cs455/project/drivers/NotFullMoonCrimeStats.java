 ...
 */
public class NotFullMoonCrimeStats {
    ...
    private void run() {
        ...
        List<LocalDate> fullMoonDates = textFile
            ...
            .filter(NotFullMoonCrimeStats::isFullMoon)
            .map(NotFullMoonCrimeStats::getDate)
        ...
        List<String> crimes = textFile
            ...
            .map(NotFullMoonCrimeStats::getType)
    ...
    private void saveStatisticsToFile(JavaSparkContext sc) {
        ...
        sc.parallelize(writeMe, 1)
            .saveAsTextFile("NotFullMoonCrimeStats");
    }
