 ...
 */
public class OutdoorNotFullMoonCrimeStats extends Driver {

    public static void main(String[] args) {
        new OutdoorNotFullMoonCrimeStats().run();
    }

    private void run() {
        SparkConf conf = new SparkConf().setAppName("Outdoor Not Full Moon Crime Stats");
        //        SparkConf conf = new SparkConf().setMaster("local").setAppName("Outdoor Not Full Moon Crime Stats");
        ...
        List<LocalDate> fullMoonDates = textFile
                ...
                .filter(OutdoorNotFullMoonCrimeStats::isFullMoon)
                .map(OutdoorNotFullMoonCrimeStats::getDate)
        ...
        List<String> crimes = textFile
                ...
                .map(OutdoorNotFullMoonCrimeStats::getType)
    ...
    private void saveStatisticsToFile(JavaSparkContext sc) {
        ...
        writeMe.add("Outdoor Not Full Moon Crime Statistics");
        writeMe.add("==================================");
        ...
        sc.parallelize(writeMe, 1).saveAsTextFile("OutdoorNotFullMoonCrimeStats");
    }
}
